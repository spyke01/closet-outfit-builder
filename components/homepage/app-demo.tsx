    ...
    <section className="py-20 lg:py-32 bg-background">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="relative max-w-4xl mx-auto">
          ...
          <div className="relative bg-gradient-to-br from-card to-background rounded-3xl p-8 shadow-2xl border border-border">
            <div className="bg-card rounded-2xl p-6 space-y-6">
              ...
              <div className="flex gap-3">
                <button className="flex-1 bg-secondary hover:bg-secondary/90 text-secondary-foreground py-3 rounded-xl font-semibold transition-colors">
                  Wear This Outfit
                </button>
                <button
                  type="button"
                  aria-label="Save outfit to favorites"
                  className="px-4 py-3 border-2 border-border bg-card rounded-xl hover:bg-card/80 transition-colors"
                >
          ...
          {/* Floating elements */}
          <div className="absolute -top-6 left-1/4 w-16 h-16 rounded-2xl bg-primary border border-border flex items-center justify-center shadow-lg">
