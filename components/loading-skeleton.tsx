...
export function TopBarSkeleton() {
  return (
    <div className="sticky top-0 z-50 w-full border-b border-stone-200 dark:border-slate-700 bg-white dark:bg-slate-800 shadow-sm">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {Array.from({ length: 8 }).map((_, i) => (
            <div key={i} className="border border-slate-200 dark:border-slate-700 rounded-lg overflow-hidden">
              ...
              <div className="h-80 bg-slate-200 dark:bg-slate-700 animate-pulse" />
    ...
    <div className="flex-1 w-full max-w-3xl mx-auto p-6">
      <div className="space-y-6">
        ...
        {Array.from({ length: 3 }).map((_, i) => (
          <div key={i} className="border border-slate-200 dark:border-slate-700 rounded-lg p-6 space-y-4">
  ...
  return (
    <div className="flex-1 w-full flex flex-col gap-12">
      <div className="w-full">
        <div className="h-12 bg-slate-200 dark:bg-slate-700 rounded-md animate-pulse" />
      </div>
      <div className="flex flex-col gap-2 items-start">
        <div className="h-8 w-48 bg-slate-200 dark:bg-slate-700 rounded animate-pulse" />
        <div className="h-32 w-full bg-slate-200 dark:bg-slate-700 rounded animate-pulse" />
      </div>
      <div>
        <div className="h-8 w-32 bg-slate-200 dark:bg-slate-700 rounded animate-pulse mb-4" />
        <div className="space-y-3">
          <div className="h-4 w-full bg-slate-200 dark:bg-slate-700 rounded animate-pulse" />
