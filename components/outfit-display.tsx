            ...
            {onSaveOutfit && userId && (
              <div className="flex justify-center gap-3">
                <button
                  ...
                  className="flex items-center gap-2 px-4 py-2 border border-border text-muted-foreground rounded-lg hover:bg-secondary/70 hover:border-foreground/25 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                  {state.isSaving ? (
                    <>
                      <SpinningIcon>
