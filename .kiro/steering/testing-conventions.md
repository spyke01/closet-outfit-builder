...
- For themed UI, prefer assertions around shared design-system intent (for example `glass-nav`, `page-shell`, `filter-tag`, explicit Liquid Glass inline style props, pressed states) over obsolete palette recipes or scale classes.
